...
$$ |\$$$ |$$ |  $$ |$$\ $$ |      $$ |  $$ | $$  $$<          \$$$  /    $$ |  
$$ | \$$ |$$ |  \$$$$  |$$ |      \$$$$$$  |$$  /\$$\          \$  /   $$$$$$\ 
\__|  \__|\__|   \____/ \__|       \______/ \__/  \__|          \_/    \______|
                                                                               
                                                                               
                                                                               
       ${chalk.italic.gray(`v${stats.version} - by Snipy`)}
`));
...
process.on('exit', () => { logger.info('Closing Nitrox... If you liked this project, make sure to leave it a star on github: https://github.com/SSnxxa1/Nitrox11 ! <3'); checkForUpdates(); });
...
(async () => {
	...
	const logStats = () => {
		...
		process.title = `Nitrox - by Snipy | Proxies: ${proxies.length + stats.threads} | Attempts: ${attempts} (~${aps.toFixed(0)}/min) | Working Codes: ${stats.working}`;
		return;
	};
